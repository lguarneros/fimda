...
# 2-D plotting tool
#
# $Id: multiplot.tcl,v 2.0 edited:  2009/02/09 17:10:10 by NL;  saam Exp $
#
# Author:
# Jan Saam
...
# $plothandle undraw <tag>		-- UNdraws item that was previously created and marked with tag from multiplot.
#					  The item can be one of.... (see command description above)
...
proc ::MultiPlot::init_plot { } {
   ...
   namespace eval $ns {
	...
	# deletes an item that has been tagges with tag $args
